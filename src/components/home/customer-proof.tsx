      ...
      <div className="mt-14 grid md:grid-cols-3 gap-5">
        {featuredCaseStudies.map((cs) => (
          ...
          >
            ...
            <p className="text-sm text-neutral-gray text-pretty">{cs.context}</p>

            <div className="mt-6 pt-5 border-t border-border">
              <div className="text-3xl font-bold text-brand-dark">
                {cs.isConfirmed ? cs.headlineStat : <span className="text-warning">TODO</span>}
              </div>
              <div className="text-xs uppercase tracking-wider text-neutral-gray mt-1">{cs.statLabel}</div>
            </div>
